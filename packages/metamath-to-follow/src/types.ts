...
export interface Frame {
  ...
  floatVarMap: Map<string, FloatNode>;
...
export interface NodeBase {
  ...
  bodyOpTree?: OpNode;
  essentialsOpTree?: Array<OpNode>;
  bodyOpTreeStr?: string;
  bodyOpTreeStrRename?: string;
  essentialsStr?: Array<string>;
  essentialsStrRename?: Array<string>;
  floatsAliasMap?: Map<string, string>;
  floatsAlias?: Array<string>;
  floatsOrder?: Array<number>;
  floatsReordered?: Array<FloatNode>;
  diffVar?: Array<string>;
  diffVarsRename?: Array<string>;
  hiddenAliasCount?: Map<string, number>;
  floatsStrOrder?: Array<number>;
  floats?: Array<FloatNode>;
}
...
export function createOpNode(definition: Node): OpNode {
  return {
    nodeType: NodeType.OP,
    children: [],
